...
export const CAREER: CareerEntry[] = [
  {
    ...
    highlights: [
      ...
      "소셜 로그인(카카오·네이버), 인앱 구독 결제·관리 백엔드 API, 카카오 알림톡·Slack 통합 알림 인프라 구축",
      "PlanNext.AI — LLM 기반 오피스 가구 배치 설계 API를 설계·개발·배포까지 주도(Coroutine·Kafka·Redis·EKS·Argo Workflow)",
      "백엔드 팀 관리·코드 리뷰 체계 정립, 기술 문서화·배포/운영 프로세스 효율화, 신규 입사자 온보딩",
    ],
    stack: ["Kotlin", "Spring Boot", "WebFlux", "Coroutine", "Kafka", "Redis", "PostgreSQL", "AWS EKS", "ArgoCD"],
  },
  {
    company: "(주) 피플리",
    period: "2021.03 – 2022.12",
    duration: "1년 10개월",
    role: "Manager / Leader / Product",
    summary: "전시 오디오 가이드 앱 '큐피커'와 전시 연계 커머스를 기획·개발·운영하고 소규모 팀을 리딩했습니다.",
    highlights: [
...
export const SKILLS = [
  ...
  },
  {
    ...
    items: ["PostgreSQL · MariaDB · MySQL", "Redis · DynamoDB", "인덱스 설계 · 쿼리 최적화 · 성능 튜닝"],
  },
  {
    group: "Tools & Collaboration",
    items: ["Git · GitHub", "Notion · Jira · Confluence", "Slack · Google Workspace", "Agile/Scrum · 코드 리뷰 · 기술 의사결정"],
  },
];
...
export const PROJECTS: ProjectEntry[] = [
  {
    name: "Landbook",
    tagline: "AI 기반 토지·건축 설계 서비스",
    period: "2023.01 – 2025",
    overview:
      "대규모 부동산·건축 설계 데이터를 AI로 처리하는 MSA 기반 서비스. 복잡한 설계 도메인을 분석해 유형별 비즈니스 로직을 개발하고, 기존 WebFlux 구조에서 잘못 구현된 블로킹 로직을 개선해 성능·안정성을 강화했습니다.",
    stack: ["Kotlin", "Spring Boot", "WebFlux", "MSA", "PostgreSQL", "JPA", "ArgoCD", "Coroutine"],
    achievements: [
      "도메인별 설계 엔진(라이트/프로) 비즈니스 로직 설계·개발",
      "잘못 구현된 블로킹 로직 개선 → 처리 속도 향상·병목 해소",
      "MSA 최적화 및 서비스 간 연동 안정성 강화",
      "소셜 로그인(카카오·네이버)·인앱 구독 결제·관리 API 개발",
      "카카오 알림톡·Slack 통합 알림 인프라 구축",
    ],
    workSlug: "landbook-msa",
  },
  {
    name: "LBDeveloper",
    tagline: "도시정비사업 원클릭 사업성 검토 AI 솔루션",
    period: "2023.01 – 현재",
    overview:
      "부동산 데이터 기반 B2B 사업성 분석 솔루션. 대국민 서비스와 공공기관 맞춤형 내부 솔루션 모두 제공하며, LH 가로주택정비사업에 설치형으로 적용해 사업성 분석·설계 자동화를 지원하고 공공기관 환경에 맞춘 보안·운영 구조를 설계·적용했습니다.",
    stack: ["Ruby", "Ruby on Rails", "PostgreSQL", "PostGIS"],
    achievements: [
      "부동산 데이터 기반 비즈니스 로직 성능 개선·유지보수 효율화",
      "설계 엔진 유형(라이트/프로)별 데이터베이스 구조 설계·개발",
      "사용자 맞춤형 사업성 분석·자동화 로직 고도화",
      "공공기관 환경 최적화 — 프록시 서버·방화벽·접근 제어 정책 등 보안·운영 구조 설계",
    ],
  ...
  {
    name: "PlanNext.AI",
    tagline: "LLM 기반 오피스 가구 배치 설계 API 서비스",
    period: "2025.03 – 현재",
    overview:
      "가구 배치를 LLM 기반 설계 엔진으로 자동화하는 API 서비스. 외부 기업이 쉽게 연동하도록 RESTful API로 설계하고, 서비스 기획부터 개발·배포까지 전 과정을 주도했습니다.",
    stack: ["Kotlin", "Spring Boot", "Coroutine", "Kafka", "Redis", "Argo Workflow", "AWS EKS"],
    achievements: [
      "Kotlin 코루틴 기반 비동기 처리·Kafka 요청 분리로 고효율·확장성 확보",
      "Redis 기반 인증·요금제·사용 이력·캐싱 설계로 성능·운영 효율 향상",
      "RESTful API 설계·스키마 정의로 외부 클라이언트 연동 용이성 제공",
      "AWS·Argo Workflow 기반 운영 환경 구축·안정적 서비스 제공",
    ],
  ...
  {
    name: "큐피커 (Qpicker)",
    tagline: "국내외 전시를 위한 오디오 가이드 앱 플랫폼",
    period: "2021.03 – 2022.12",
    overview:
      "국내외 전시·박람회에서 오디오 가이드를 제공하는 앱 서비스. 모바일 앱과 관리자 페이지에 연동되는 백엔드 API를 개발·운영하며 전시 기획사와의 파트너십을 확대했습니다.",
    stack: ["Java", "Spring Boot", "MariaDB", "JPA"],
    achievements: [
      "모바일 앱·관리자 페이지 연동 백엔드 API 개발",
      "Firebase·PG 등 외부 서비스 연동 처리",
      "전시별 맞춤형 콘텐츠 제공·서비스 안정성 확보",
      "누적 다운로드 10만+ 달성, 하리보 아시아 전시 계약 성사",
    ],
...
export const CASES: CaseEntry[] = [
  {
    ...
    approach: ["코드·아키텍처 분석 후 API·배포·운영 체계 재정비", "신규 기능을 기획부터 설계·구현까지 개발 프로세스 주도"],
    result: ["실 서비스 정상화·고도화, 팀 내 기술 의사결정과 핵심 비즈니스 로직 개발을 이끌며 백엔드 리더로 성장"],
  },
  {
    title: "대규모 알림 처리 병목 해소",
    situation: ["순차 처리 구조로 수만 건 알림 발송 시 과부하·지연", "이벤트 루프에서 동기 호출 → 스레드 블로킹·병목"],
    approach: ["병렬 비동기 처리 구조 도입(청크 + 병렬 파이프라인)", "오프로딩(boundedElastic)·백오프 재시도(3회/5s)"],
    result: ["알림 처리 수 분 → 수 초로 단축, 장애 해소·운영 가시성 향상", "이벤트 루프 블로킹 제거로 처리량·CPU 효율 상승"],
  },
  {
    title: "MSA 환경 적응과 실무 적용",
    situation: ["이미 MSA 구조였으나 복잡한 서비스 간 연동·장애 대응을 위해 구조·동작 숙지 필요"],
    approach: ["서비스 설계·배포·운영 흐름을 분석하며 MSA 구성 요소·통신·배포 전략 습득", "WebFlux·비동기/분산 처리의 동작 원리·활용을 실무에서 빠르게 익힘"],
    result: ["서비스 간 연동 안정성 향상·장애 영향 최소화", "MSA 경험을 바탕으로 신규 기능 설계·성능 개선 시 기술 의사결정 참여"],
  },
  {
    title: "지연·실패율 완화: 라이트 분석 경로 분기",
    situation: ["기존 '프로' 분석은 모든 케이스를 분석해 설계 시간 지연", "간소화된 분석 서비스가 필요"],
    approach: ["AI 개발 파트와 협업해 간소화된 '라이트' 모델 생성으로 빠른 분석 경로 마련", "신규 모델을 사용하는 API 개발"],
    result: ["3분 이내에 설계 결과를 확인할 수 있는 기능 개발", "유입률·설계 성공률 개선"],
  },
  {
    title: "구독 서비스 확장: 결제·갱신·만료 자동화",
    situation: ["단건 결제 중심 구조로 재사용성·수익화 확대에 한계"],
    approach: ["월/연 구독·무료 체험·쿠폰·결제 예정 알림 등 구독 로직 설계", "RevenueCat·PG 웹훅 기반 결제·갱신 처리, 만료·갱신 실패 시 재시도·알림 자동화"],
    result: ["결제·갱신·만료 자동화로 운영 부담 감소", "구독 전환율·유지율 개선"],
  },
  {
    title: "설계 요청 부하 분산",
    situation: ["B2B 설계 요청이 단일 API에 집중되어 병목 발생"],
    approach: ["Kafka 기반 메시징·Consumer 서버 분리·Argo Workflows 연동"],
    result: ["병렬 처리·부하 분산 실현, 안정적 확장성 확보"],
  },
];
