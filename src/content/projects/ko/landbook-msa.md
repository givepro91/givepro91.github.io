...
decision: "이미 MSA로 나뉜 환경에서 제가 판단한 건, 서비스를 더 쪼개는 게 아니라 <b>무엇을 같은 트랜잭션에 둘지·어디서 장애를 격리할지</b>였습니다. 무거운 작업은 Kafka로 떼어내 격리하고, 인증·사용량·캐시는 Redis로, 동기 호출을 Coroutine 비동기로 바꿔 한 서비스의 지연이 옆 서비스를 잡아먹지 않게 했습니다."
